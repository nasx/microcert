...
def create_certificate(ca_crt: Certificate, ca_key: Certificate, request_json):
    ...
    for name in alt_names_raw:
        try:
            # Auto-detect IP vs DNS to prevent crashes
    ...
    # Note: default_backend() is no longer required in sign() for modern cryptography lib
